...
const char* deepgramApiKey =    "SPEECH TO TEXT API KEY ";   // ## INSERT your Deepgram credentials , CURRENTLY IAM USING DEEPGRAM API ,BUT GOOGLE SPEECH TO TEXT CAN ALSO BE USED.
